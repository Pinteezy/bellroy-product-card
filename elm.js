...
var $author$project$ProductCard$init = {
	colorOptions: _List_fromArray(
		['black', 'cocoa', 'navy', 'green']),
	...
	price: '$89',
	selectedColor: $elm$core$Maybe$Nothing,
...
var $author$project$ProductCard$SelectColor = function (a) {
...
var $author$project$ProductCard$colorSwatch = F2(
	function (selected, color) {
		var borderStyle = function () {
			if (selected.$ === 'Just') {
				var c = selected.a;
				return _Utils_eq(c, color) ? '2px solid #000' : '1px solid #ccc';
			} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$ProductCard$SelectColor(color))
				]),
			_List_Nil);
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$html$Html$Attributes$alt(model.title),
				...
				A2(
					$elm$core$List$map,
					$author$project$ProductCard$colorSwatch(model.selectedColor),
					model.colorOptions))
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{init: $author$project$ProductCard$init, update: $author$project$ProductCard$update, view: $author$project$ProductCard$view});
